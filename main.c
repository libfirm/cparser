...
{
	add_define("OBJC_NEW_PROPERTIES",    "1");
	add_define("__APPLE_CC__",           "5490");
	add_define("__APPLE__",              "1");
	add_define("__CHAR_BIT__",           "8");
	add_define("__CONSTANT_CFSTRINGS__", "1");
	add_define("__DBL_DENORM_MIN__",     "4.9406564584124654e-324");
	add_define("__DBL_DIG__",            "15");
	add_define("__DBL_EPSILON__",        "2.2204460492503131e-16");
	add_define("__DBL_HAS_INFINITY__",   "1");
	add_define("__DBL_HAS_QUIET_NAN__",  "1");
	add_define("__DBL_MANT_DIG__",       "53");
	add_define("__DBL_MAX_10_EXP__",     "308");
	add_define("__DBL_MAX_EXP__",        "1024");
	add_define("__DBL_MAX__",            "1.7976931348623157e+308");
	add_define("__DBL_MIN_10_EXP__",     "(-307)");
	add_define("__DBL_MIN_EXP__",        "(-1021)");
	add_define("__DBL_MIN__",            "2.2250738585072014e-308");
	add_define("__DECIMAL_DIG__",        "21");
	add_define("__DYNAMIC__",            "1");
	add_define("__ENVIRONMENT_MAC_OS_X_VERSION_MIN_REQUIRED__", "1058");
	add_define("__FINITE_MATH_ONLY__",   "0");
	add_define("__FLT_DENORM_MIN__",     "1.40129846e-45F");
	add_define("__FLT_DIG__",            "6");
	add_define("__FLT_EPSILON__",        "1.19209290e-7F");
	add_define("__FLT_EVAL_METHOD__",    "0");
	add_define("__FLT_HAS_INFINITY__",   "1");
	add_define("__FLT_HAS_QUIET_NAN__",  "1");
	add_define("__FLT_MANT_DIG__",       "24");
	add_define("__FLT_MAX_10_EXP__",     "38");
	add_define("__FLT_MAX_EXP__",        "128");
	add_define("__FLT_MAX__",            "3.40282347e+38F");
	add_define("__FLT_MIN_10_EXP__",     "(-37)");
	add_define("__FLT_MIN_EXP__",        "(-125)");
	add_define("__FLT_MIN__",            "1.17549435e-38F");
	add_define("__FLT_RADIX__",          "2");
	add_define("__GNUC_GNU_INLINE__",    "1");
	add_define("__GNUC_MINOR__",         "2");
	add_define("__GNUC_PATCHLEVEL__",    "1");
	add_define("__GNUC__",               "4");
	add_define("__GXX_ABI_VERSION",      "1002");
	add_define("__INTMAX_MAX__",         "9223372036854775807LL");
	add_define("__INTMAX_TYPE__",        "long long int");
	add_define("__INT_MAX__",            "2147483647");
	add_define("__LDBL_DENORM_MIN__",    "3.64519953188247460253e-4951L");
	add_define("__LDBL_DIG__",           "18");
	add_define("__LDBL_EPSILON__",       "1.08420217248550443401e-19L");
	add_define("__LDBL_HAS_INFINITY__",  "1");
	add_define("__LDBL_HAS_QUIET_NAN__", "1");
	add_define("__LDBL_MANT_DIG__",      "64");
	add_define("__LDBL_MAX_10_EXP__",    "4932");
	add_define("__LDBL_MAX_EXP__",       "16384");
	add_define("__LDBL_MAX__",           "1.18973149535723176502e+4932L");
	add_define("__LDBL_MIN_10_EXP__",    "(-4931)");
	add_define("__LDBL_MIN_EXP__",       "(-16381)");
	add_define("__LDBL_MIN__",           "3.36210314311209350626e-4932L");
	add_define("__LITTLE_ENDIAN__",      "1");
	add_define("__LONG_LONG_MAX__",      "9223372036854775807LL");
	add_define("__LONG_MAX__",           "2147483647L");
	add_define("__MACH__",               "1");
	add_define("__MMX__",                "1");
	add_define("__NO_INLINE__",          "1");
	add_define("__PIC__",                "1");
	add_define("__PTRDIFF_TYPE__",       "int");
	add_define("__REGISTER_PREFIX__",    "");
	add_define("__SCHAR_MAX__",          "127");
	add_define("__SHRT_MAX__",           "32767");
	add_define("__SIZE_TYPE__",          "long unsigned int");
	add_define("__SSE2_MATH__",          "1");
	add_define("__SSE2__",               "1");
	add_define("__SSE_MATH__",           "1");
	add_define("__SSE__",                "1");
	add_define("__STDC_HOSTED__",        "1");
	add_define("__UINTMAX_TYPE__",       "long long unsigned int");
	add_define("__USER_LABEL_PREFIX__",  "_");
	add_define("__VERSION__",            "\"4.0.1 (Apple Inc. build 5490)\"");
	add_define("__WCHAR_MAX__",          "2147483647");
	add_define("__WCHAR_TYPE__",         "int");
	add_define("__WINT_TYPE__",          "int");
	add_define("__i386",                 "1");
	add_define("__i386__",               "1");
	add_define("__strong",               "");
	add_define("__weak",                 "");
	add_define("i386",                   "1");
}
